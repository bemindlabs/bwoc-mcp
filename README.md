...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-v1.1.2-brightgreen">
...
**v1.1.2.** Both transports (**stdio** + **Streamable HTTP** with bearer auth),
...
Desktop extension** (`.mcpb` bundle, attached to each release). v1.1.2 makes
`bwoc_fleet` / `bwoc://fleet` work on bwoc 3.x (`fleet health`). See the
